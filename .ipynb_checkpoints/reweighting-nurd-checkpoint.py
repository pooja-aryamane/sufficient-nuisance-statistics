...
if __name__=="__main__":
    ...
    experiment = f'wd_{str(args.WEIGHT_DECAY)}+pretrained_{str(args.PRETRAINED)}+batchsize_{str(args.BATCH_SIZE)}+lr_{args.LEARNING_RATE}+transform_{args.TRANSFORM}'
    ...
    train_dataloader, val_dataloader, test_dataloader = get_loaders_rw(chexpert_dir, mimic_dir, args.IMAGE_SIZE, args.NORMALISE, args.TRANSFORM, args.NWORKERS, args.BATCH_SIZE, args.BORDER_SZ, 'true_group_idx') 
